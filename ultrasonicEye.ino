...
#define  CLK_PIN   5  // We are using hardware SPI - make sure you have connected the CLK pin to the hardware CLK pin on your device
#define DATA_PIN  6  // We are using hardware SPI - make sure you have connected the MOSI pin to the hardware MOSI pin on your device
